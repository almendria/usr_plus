        ...
        <div class="content">
            ...
            <form action="process.php" method="POST">
                ...
                <p>
                    ...
                    <input type="radio" id="Socialist Republic of Oštra" name="jurisdiction" value="Socialist Republic of Oštra">
                    <label>Socialist Republic of Oštra</label><br>
                    ...
                    <label>Ambestanian Soviet Socialist Republic</label><br>
